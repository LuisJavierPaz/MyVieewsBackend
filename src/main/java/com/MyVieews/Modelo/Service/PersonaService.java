...
public class PersonaService implements PersonaRepository{//agregamos una implementacion del repositorio( implements "nombre del repositorio"
	//creamos un atributo del repositorio
		...
		//implementamos todos los metodos que requerimos
		@Override
